...
export const INITIAL_PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    features: [
      'Pecuária intensiva e agricultura de precisão',
...
export const INITIAL_MACHINES: Machine[] = [
  ...
  },
  {
    ...
    priceDisplay: 'Sob Consulta',
    description: 'Plantadeira de alta precisão articulada com dosadores a vácuo, corte perfeito de palhada e monitor de sementes tela touch para alta produtividade em campo',
    specs: [
...
export const INITIAL_LEADS: Lead[] = [
  ...
  },
  {
    ...
    investmentRange: 'Arrendamento Safra e Safrinha',
  ...
  },
  {
    ...
    targetTitle: 'Plantadeira New Holland PL6000',
    investmentRange: 'R$ 1,5MM a R$ 3MM',
    message: 'Procuro plantadeira seminova para a próxima safra com sistema de dosagem a vácuo',
